...
# Last updated 08/31/2013 - J0hnnyBrav0
...
f_debian(){
	...
	reqs="cmake gcc g++ subversion wget libssl-dev libpcap0.8 libpcap0.8-dev libssl-dev libssl0.9.8 libssl1.0.0 libtool hostapd dsniff ipcalc isc-dhcp-server aircrack-ng xterm"
